...
const MainSite: React.FC = () => {
  return (
    <div className="animate-[fadeIn_0.5s_ease-out] bg-black text-white">
      {/* HERO SECTION */}
        ...
        <div className="relative z-10 px-6 max-w-md mx-auto w-full">
           ...
           <div className="space-y-4">
             <a 
               href={WHATSAPP_URL} 
               target="_blank" 
               className="flex items-center justify-center w-full py-5 px-8 gold-gradient text-black rounded-2xl font-black text-base shadow-[0_15px_40px_rgba(212,175,55,0.25)] btn-pulse active:scale-95 transition-all uppercase tracking-widest"
             >
      ...
      <section className="py-32 bg-black relative">
        ...
        <div className="px-6 max-w-md mx-auto text-center space-y-10 relative z-10">
          ...
          <div className="space-y-6 pt-4">
            <a 
              href={WHATSAPP_URL} 
              className="flex items-center justify-center w-full py-6 px-8 gold-gradient text-black rounded-2xl font-black text-base shadow-2xl btn-pulse active:scale-95 transition-all uppercase tracking-widest"
            >
      ...
      <footer className="py-20 bg-[#050505] text-center border-t border-white/5">
        <div className="px-6 max-w-md mx-auto space-y-10">
          ...
          <div className="flex justify-center gap-6">
             <a href={INSTAGRAM_URL} className="p-3 bg-white/5 rounded-full border border-white/10 text-gold-500 hover:text-white transition-colors">
